...
public abstract class Auto extends LinearOpMode {
    ...
    //motors this year
    private DcMotorEx leftFront, leftBack, rightFront, rightBack, intake, shooter, leftDead, rightDead, perpDead;
    //motors last year
    private DcMotorEx rightIntake, leftIntake, leftVerticalSlide, rightVerticalSlide;
    //Servos this year
    private Servo wobbleClaw, wobbleArm, outtakeLoader;
    //Servos last year
    ...
    private RING_COUNT ringOrientation;
    ...
    public void initMotors() {
        ...
        baseParallelRightPosition = rightDead.getCurrentPosition();
    ...
    public void initServos() {
        ...
        outtakeLoader = hardwareMap.servo.get("outtakeLoader");

        wobbleClaw.setPosition(0);
        wobbleArm.setPosition(0);
        outtakeLoader.setPosition(1);
    }

    public void initSensors() {
        //init autoBlockGrabber distance sensors
        blockLeftSensor = hardwareMap.get(DistanceSensor.class, "blockLeftSensor");//uhuhhhhh what is this
...
//            telemetry.update();
    ...
    public void splineMove(double[] xcoords, double[] ycoords, double maximumPower, double initPower, double finalPower, double offset, boolean halt) throws InterruptedException {
        double baseParallelLeftTicks = leftDead.getCurrentPosition();
        double baseParallelRightTicks = -rightDead.getCurrentPosition();
